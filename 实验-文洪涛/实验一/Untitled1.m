...
%直方图
figure,subplot(2,1,1),hist(s);title('自编随机数的ksdensity估计的概率密度');
subplot(2,1,2),hist(s,100);
title('自编随机数的ksdensity估计的100份概率密度');
figure,subplot(2,1,1),hist(y);title('对照随机数的ksdensity估计的概率密度');
subplot(2,1,2),hist(y,100);
title('对照随机数的ksdensity估计的100份概率密度');
